...
namespace Unity.MLAgents.Sensors
{
    ...
    public class RayCNNComponent : SensorComponent, IDisposable
    {
        RayCNNSensor m_Sensor;
        ...
        public OptimizedRayCast optimizedRayCast;
        /// <summary>
        ...
        {
            Dispose();
            m_Sensor = new RayCNNSensor(optimizedRayCast, texture2D, Grayscale, SensorName, m_Compression);
    ...
    public class RayCNNSensor : ISensor, IDisposable
    {
        ...
        Texture2D m_Texture;
        OptimizedRayCast optimizedRayCast;
        ...
        public RayCNNSensor(OptimizedRayCast s, Texture2D tex,
